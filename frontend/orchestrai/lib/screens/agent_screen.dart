...
class AssembledAgentView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        Image.asset('assets/${_getAssetPrefix("머리")}_${agent.headAsset}.png', height: 100),
        Image.asset('assets/${_getAssetPrefix("태스크")}_${agent.bodyAsset}.png', height: 150),
        Image.asset('assets/${_getAssetPrefix("도구")}_${agent.toolAsset}.png', height: 100),
      ],
    );
  }
}
        ...
        return GestureDetector(
          ...
          child: Card(
            child: Column(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Image.asset('assets/${assetPrefix}_${index + 1}.png', height: 50),
                Text('옵션 ${index + 1}'),
              ],
            ),
          ),
